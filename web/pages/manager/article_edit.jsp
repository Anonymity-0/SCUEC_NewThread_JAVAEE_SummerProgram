...
<body>
		...
		<div id="main">
			<form action="manager/ArticleServlet",method="get">
				...
				<table>
					...
					<tr>
						...
						<td><input name="id" type="text" value="${requestScope.article.id}"/></td>
						<td><input name="author" type="text" value="${requestScope.article.author}"/></td>
